        ...
        for j in range(opt.Dsteps):
            ...
            if (j==0) & (epoch == 0): # Initialization
                if Gs == []: # Layer N, noise only
                    ...
                    prev = torch.full([1,opt.nc_z,opt.nzx,opt.nzy], 0, device=opt.device) # first z (all 0)
                    prev = m_image(prev) 
    ...
    while scale_num < opt.stop_scale + 1:
        ...
        for epoch in range(opt.niter):
            ...
            for i in range(datasize):
                ...
                z_curr, in_s, G_curr = train_single_scale_seg(D_curr, G_curr, reals, segs, Gs, Zs, in_s, NoiseAmp, opt, allow_write=(epoch % 10 == 0))
